...
export default {
  ...
  data() {
    return {
      ...
      valueFirst: null,
      barMin: 0,
      barMax: maxValues("priceM2"),
      barMinValue: 0,
      barMaxValue: maxValues("priceM2"),
      cMax: maxValues("priceM2"),

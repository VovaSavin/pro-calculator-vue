...
export default {
  ...
  data() {
    return {
      ...
      valueFirst: null,
      barMin: 0,
      barMax: maxValues("fullPrice"),
      barMinValue: 0,
      barMaxValue: maxValues("fullPrice"),
      cMax: maxValues("fullPrice"),

...
export default {
  ...
  data() {
    return {
      ...
      valueFirst: null,
      barMin: 0,
      barMax: maxValues("square"),
      barMinValue: 0,
      barMaxValue: maxValues("square"),
      cMax: maxValues("square"),
